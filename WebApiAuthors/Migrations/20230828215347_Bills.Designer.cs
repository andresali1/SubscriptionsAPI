...
namespace WebApiAuthors.Migrations
{
    ...
    [Migration("20230828215347_Bills")]
    partial class Bills
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiAuthors.Entities.APIKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiAuthors.Entities.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.Property<bool>("BadPaymentHistory")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("WebApiAuthors.Entities.DomainRestriction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApiAuthors.Entities.IPRestriction", b =>
                {
                    ...
                    b.ToTable("IPRestriction");
                });

            modelBuilder.Entity("WebApiAuthors.Entities.Request", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebApiAuthors.Entities.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebApiAuthors.Entities.DomainRestriction", b =>
                {
                    b.HasOne("WebApiAuthors.Entities.APIKey", "Key")
